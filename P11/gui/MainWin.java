...
public class MainWin extends JFrame {
    ...
    public MainWin() {
       ...
       // Add a New Emporium icon
        ...
        JButton createContainerButton  = new JButton(new ImageIcon("gui/bowl.png"));
        ...
        JButton createMixInFlavorButton  = new JButton(new ImageIcon("gui/flav.png"));
        ...
        createOrderButton  = new JButton(new ImageIcon("gui/bowl.png"));
        ...
        JButton createCustomerButton = new JButton(new ImageIcon("gui/group (2).png"));
        createCustomerButton.setActionCommand("new Customer");
        createCustomerButton.setToolTipText("creat new customer");
        toolbar.add(createCustomerButton);
        createCustomerButton.addActionListener(event -> onCreateCustomerClick());

        toolbar.add(Box.createHorizontalStrut(25));
        
        JButton viewContainersButton  = new JButton(new ImageIcon("gui/bowl.png"));
        ...
        JButton viewMixInFlavorsButton  = new JButton(new ImageIcon("gui/flav.png"));
        ...
        JButton viewCustomerButton =new JButton(new ImageIcon("gui/group (2).png"));
            viewCustomerButton.setActionCommand("View orders");
    ...
    protected void onCreateCustomerClick(){
        try {
            ...
            JLabel phone = new JLabel("<html><br/>Description</html>");
...
/*        
    ...
    protected void onCreateOrderClick() {
        ...
        try {
            ...
            Customer pick = (Customer) JOptionPane.showInputDialog(this, "What Customer?", "pick person", JOptionPane.QUESTION_MESSAGE, null, emporium.customer(), null);
            while((serving = onCreateServing(pick)) != null) {
                if(order == null) {
                   //changed
                    order = new Order(pick);
                }
    ...
    protected Serving onCreateServing(Customer pick) {
        Serving serving = null; 
        if(emporium.favoriteServings(pick).length!=0){
            serving =(Serving) JOptionPane.showInputDialog(this, "Faviort serving?", "New Servig", JOptionPane.QUESTION_MESSAGE, null,emporium.favoriteServings(pick), null);
        }
        else{
        try {
            ...
            if(container != null) {
                ...
                while((scoop = onCreateScoop()) != null) {
                    ...
                    noScoop = false;
                    if((container.maxScoops())!=(serving.numScoops())){
                    int result = JOptionPane.showConfirmDialog(
...
*/
    ...
    private void view(Screen screen) {
        ...
        switch(screen) {
            ...
            case CUSTOMERS: 
                 title = "Customer";
                 for(var t : emporium.customer()) s.append(t.toString() + "<br/>");
                 break;
             case ORDERS: 
                 title = "Orders";
                 int orderNumber = 1;
